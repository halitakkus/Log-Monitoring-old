...
{
    public class ApplicationConfigurationContext : IApplicationConfigurationContext
    {
        ...
        public ApplicationConfigurationContext(IEnvironmentService environmentService)
        {
